...
class minimap_gps(object):
    ...
    map_files =  {'camp_jackal' : package_directory + '/../../assets/map/low_res/Camp_Jackal_Main_Low_Res.png',
                  'miramar'     : package_directory + '/../../assets/map/low_res/Miramar_Main_Low_Res.png'}
    ...
    def __init__(self,map_name, map_scale = 0.5):
        ...
        self.player_point_img = plt.imread(package_directory + '/player_point.jpg').astype(np.uint8)
